...
data_joint   = read_csv_data( CSV_FILENAME, "dfw.topo.sh")
data_weights = read_csv_data( CSV_FILENAME, "newWeights.topo.sh")
...
print("dfw Median: ", statistics.median(data_joint))
print("WEIGHTS Median: ", statistics.median(data_weights))
print("dfw Minimum: ", min(data_joint))
print("WEIGHTS Minimum: ", min(data_weights))
print("dfw Maximum: ", max(data_joint))
