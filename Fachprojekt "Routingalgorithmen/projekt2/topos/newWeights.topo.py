...
class newWeights(Topo):
    def build(self):
        ...
        self.add_node("3")
        self.add_node("4")
        self.add_link_name("0", "1", cost=2000, delay=0.2, bw=20000000000000, directed=True)
        self.add_link_name("1", "0", cost=2000, delay=0.2, bw=20000000000000, directed=True)
        self.add_link_name("0", "3", cost=3000, delay=0.2, bw=10000000000000, directed=True)
        self.add_link_name("3", "0", cost=3000, delay=0.2, bw=10000000000000, directed=True)
        self.add_link_name("1", "2", cost=4000, delay=0.2, bw=15000000000000, directed=True)
        self.add_link_name("2", "1", cost=4000, delay=0.2, bw=15000000000000, directed=True)
        self.add_link_name("1", "4", cost=4000, delay=0.2, bw=10000000000000, directed=True)
        self.add_link_name("4", "1", cost=4000, delay=0.2, bw=10000000000000, directed=True)
        self.add_link_name("2", "3", cost=3000, delay=0.2, bw=10000000000000, directed=True)
        self.add_link_name("3", "2", cost=3000, delay=0.2, bw=10000000000000, directed=True)
        self.add_link_name("3", "4", cost=5000, delay=0.2, bw=20000000000000, directed=True)
        self.add_link_name("4", "3", cost=5000, delay=0.2, bw=20000000000000, directed=True)
...
topos = {'newWeights': (lambda: newWeights())}
