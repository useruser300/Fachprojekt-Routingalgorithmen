...
from algorithm.segment_routing.demand_first_waypoints_available import DemandFirstWaypointsAvailableCapacities
from algorithm.segment_routing.demand_first_waypoints_capacities import DemandFirstWaypointsCapacities
from algorithm.segment_routing.demand_first_waypoints_utilization import DemandFirstWaypointsUtilization
...
def get_algorithm(algorithm_name: str, nodes: list, links: list, demands: list, weights=None, waypoints=None,
    ...
    elif algorithm_name == "demand_first_waypoints_available":
        algorithm = DemandFirstWaypointsAvailableCapacities(nodes, links, demands, weights, waypoints)
    elif algorithm_name == "demand_first_waypoints_capacities":
        algorithm = DemandFirstWaypointsCapacities(nodes, links, demands, weights, waypoints)
    elif algorithm_name == "demand_first_waypoints_utilization":
        algorithm = DemandFirstWaypointsUtilization(nodes, links, demands, weights, waypoints)
